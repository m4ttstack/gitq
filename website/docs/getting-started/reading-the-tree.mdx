...
See [`gitq stacks`](/reference/read-only/stacks) for the full flag and JSON reference.
...
See [`gitq diagnose`](/reference/read-only/diagnose) for the full situation list and JSON reference.
...
See [`gitq preflight`](/reference/read-only/preflight) for the full flag and JSON reference.
