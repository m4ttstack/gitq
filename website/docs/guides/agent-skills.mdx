...
The skill files are the actual prompts driving these agents, and one detail in them is still stale relative to what the code underneath now does. It matters enough to call out explicitly rather than let a skill's own description mislead you:
